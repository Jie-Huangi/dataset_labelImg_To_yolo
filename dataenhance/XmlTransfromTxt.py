...
if __name__ == '__main__':
    ...
    image_set = 'labels'  # 需要转换的文件夹名称（文件夹内放xml标签文件）
    imageset2 = 'xmlTotxt_enhanced'  # 保存txt的文件夹
    # 2.
    # 换成你的类别 当前的顺序，就txt 0,1,2,3 四个类别
    classes = ['nailong', 'xiaoqi']  # 标注时的标签 注意顺序一定不要错。

    # 3.
    # # 转换文件夹的绝对路径
    # data_dir = '/home/bruce/Documents/Bilibili_Record/dataset/enhanced_data'
    # 或者 读取当前路径
