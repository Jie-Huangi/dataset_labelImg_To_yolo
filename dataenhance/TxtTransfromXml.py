...
out_root = r'/home/bruce/Documents/Bilibili_Record/dataset/xmldata'  # xml文件存放路径
...
def get_root_lst(root, suffix='png', suffix_n=3):
    root_lst, name_lst = [], []
...
def yolov5txt2xml(root_data, txt_root, gt_labels=None, out_dir=None):
    # 获得图像与txt的路径与名称的列表
    img_roots_lst, img_names_lst = get_root_lst(root_data, suffix='png', suffix_n=3)
...
if __name__ == '__main__':
    ...
    root_path = r'/home/bruce/Documents/Bilibili_Record/dataset/nailong_data/images'  # 图片路径
    txt_root = r'/home/bruce/Documents/Bilibili_Record/dataset/nailong_data/labels'   # txt路径

    gt_labels = ['nailong', 'xiaoqi']
